...
CREATE TABLE `t_course` (
  ...
  `STUDENT_NUMBER` int(5) DEFAULT NULL COMMENT '学生数',
  `SPECIALTY` varchar(10) DEFAULT NULL COMMENT '专业ID',
...
-- Records of t_course
-- ----------------------------
INSERT INTO `t_course` VALUES ('DDJHAT0SKb', 'eyYAM09nIF', '数据结构与算法', '', '22', '22', '020202', '', '专业基础课', '--请选择考核方式--', '', 'Qsq73xbQDS', null);
INSERT INTO `t_course` VALUES ('qJTKcpG0Mc', 'eyYAM09nIF', 'java编译原理', '这是一门计算机课程', '1', '22', '010102', '理论', '公共选修课', '考查课', '', 'Qsq73xbQDS', null);
...
CREATE TABLE `t_course_cell` (
  ...
  `WEEKDAY` varchar(20) DEFAULT NULL COMMENT '星期几（多个值用小数点隔开 如2.5）',
...
-- ----------------------------
-- Table structure for `t_course_score`
-- ----------------------------
DROP TABLE IF EXISTS `t_course_score`;
CREATE TABLE `t_course_score` (
...
-- ----------------------------
-- Records of t_course_score
-- ----------------------------
INSERT INTO `t_course_score` VALUES ('3e6xCAJiWl', 'oivGF6JsOP', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('4GYFTUISie', 'DDJHAT0SKb', '气质', '25.00', '0', null, null);
INSERT INTO `t_course_score` VALUES ('8ZP0CFEaYr', 'oivGF6JsOP', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('9jx9381J2J', '1uZ4NjUwPV', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('AZszApX5V0', 'qJTKcpG0Mc', '期中', '20.00', '1', null, null);
INSERT INTO `t_course_score` VALUES ('BG6vhpRsmq', 'oivGF6JsOP', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('bSX0UjvtTZ', 'pc8tAC1Vkq', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('DJg65ln2kK', 'pc8tAC1Vkq', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('EfRqIn5ycS', 'jZloRzcLZY', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('FfLl8TtShy', 'qJTKcpG0Mc', '劳动', '10.00', '3', null, null);
INSERT INTO `t_course_score` VALUES ('gESJnSu4dS', 'GpkrUlUx5t', '期中', '20.00', '1', null, null);
INSERT INTO `t_course_score` VALUES ('hJxpSrkSal', 'kwDfYtfhnP', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('hLZdZn33gn', 'DDJHAT0SKb', '体重', '50.00', '2', null, null);
INSERT INTO `t_course_score` VALUES ('iPylES9fzU', 'Lhu14i9fn0', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('iXLvkw95Yu', '1uZ4NjUwPV', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('KlwTGVJJpk', 'pc8tAC1Vkq', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('lh8WNSN9eC', 'DDJHAT0SKb', '长相', '15.00', '1', null, null);
INSERT INTO `t_course_score` VALUES ('LLtRHeSXYg', 'Lhu14i9fn0', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('lUxUOMejYN', 'jZloRzcLZY', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('N4GBLKEt3X', 'qJTKcpG0Mc', '平时', '30.00', '0', null, null);
INSERT INTO `t_course_score` VALUES ('ngqND4qy4O', 'DDJHAT0SKb', '身高', '10.00', '3', null, null);
INSERT INTO `t_course_score` VALUES ('OkBhUrivGA', 'GpkrUlUx5t', '期末', '60.00', '2', null, null);
INSERT INTO `t_course_score` VALUES ('pRNQCEBhmx', '1uZ4NjUwPV', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('QFEtR9G5YJ', 'kwDfYtfhnP', '平时', null, '0', null, null);
INSERT INTO `t_course_score` VALUES ('sZvOOdDBDt', 'qJTKcpG0Mc', '期末', '40.00', '2', null, null);
INSERT INTO `t_course_score` VALUES ('TblD2hiYPU', 'Lhu14i9fn0', '期末', null, '2', null, null);
INSERT INTO `t_course_score` VALUES ('tOqU8jRGmh', 'kwDfYtfhnP', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('UJIG2KEeLm', 'jZloRzcLZY', '期中', null, '1', null, null);
INSERT INTO `t_course_score` VALUES ('ZA4Lvv4RIu', 'GpkrUlUx5t', '平时', '20.00', '0', null, null);
...
CREATE TABLE `t_dictionary2_public` (
  ...
  `TYPE` int(2) DEFAULT NULL COMMENT '字典表类型。 01：课程类型   02：授课方式  03：考核类型  04：职称  05:职务  06：课程资源类型   07：电子邮箱   08：联系电话   09：IM ',
  `CODE` int(5) DEFAULT NULL COMMENT '类型编码',
  `PARENT_CODE` int(5) DEFAULT NULL COMMENT '父类的类型编码',
  `VALUE` varchar(20) DEFAULT NULL COMMENT '名称，值',
  `LEVEL` int(2) DEFAULT NULL COMMENT '层级，到根节点的层级',
...
CREATE TABLE `t_log` (
  ...
  `TARGET_ID` varchar(10) DEFAULT NULL COMMENT '目标对象ID（此处为通知ID或课程ID）',
  `TIME` varchar(20) DEFAULT NULL COMMENT '时间',
  `TYPE` int(2) DEFAULT NULL COMMENT '日志类型。    01：课程签到日志    02：通知查看日志',
  PRIMARY KEY (`LOG_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_notice` (
  ...
  `PUBLISH_TYPE` char(2) DEFAULT NULL COMMENT '发布类型（01草稿 02发布/待发布）',
...
-- Records of t_notice
-- ----------------------------
INSERT INTO `t_notice` VALUES ('1', 'qJTKcpG0Mc', '测试通知标题', '123', '02', '2016-06-24 11:11:41', '2016-06-16 17:07:27', 'Qsq73xbQDS', null);
INSERT INTO `t_notice` VALUES ('FrBhdpvRTR', 'DDJHAT0SKb', '啊啊', '是', '02', '2016-06-17 09:52:28', '2016-06-17 09:52:28', 'Qsq73xbQDS', null);
INSERT INTO `t_notice` VALUES ('hedjl1iY4i', 'DDJHAT0SKb', 'futrue', 'ss', '03', '2016-06-25 10:35:22', '2016-06-24 10:35:29', 'Qsq73xbQDS', null);
INSERT INTO `t_notice` VALUES ('iYM4nLL0IM', 'qJTKcpG0Mc', '啊啊啊啊啊啊啊啊啊', '试试', '03', '2016-06-18 09:52:42', '2016-06-17 09:52:55', 'Qsq73xbQDS', null);
INSERT INTO `t_notice` VALUES ('timz2XxiLO', 'DDJHAT0SKb', 'hhhh', 'hhh', '02', '2016-06-24 10:32:39', '2016-06-24 10:32:39', 'Qsq73xbQDS', null);
...
CREATE TABLE `t_status` (
  `WS_ID` varchar(10) NOT NULL DEFAULT '' COMMENT '学生作业/通知完成标识主键',
  `WORK_ID` varchar(10) DEFAULT NULL COMMENT '目标ID（此处为作业ID或通知ID）',
...
-- Records of t_work
-- ----------------------------
INSERT INTO `t_work` VALUES ('iMldgjZkn9', 'qJTKcpG0Mc', '测试啊啊啊', '22', '01', '2016-07-05 10:35:07', null, '2016-07-04 10:34:57', null, null);
INSERT INTO `t_work` VALUES ('mqAUNlDNi6', 'DDJHAT0SKb', '321654987', null, '01', '2016-09-23 10:47:44', '2016-09-24 10:35:07', '2016-09-23 10:34:03', '10', '0');
INSERT INTO `t_work` VALUES ('qxEsCNVQCp', 'DDJHAT0SKb', 'ä»å¤©æ²¡æçä½ä¸', null, '01', '2016-09-23 10:35:07', '2016-09-24 10:35:07', '2016-09-23 10:31:05', '10', '1');
INSERT INTO `t_work` VALUES ('roDpTAmJG0', 'qJTKcpG0Mc', '熟悉虚拟机', '3', '02', '2016-07-05 14:25:47', '2016-07-08 14:25:47', '2016-07-04 10:34:41', null, null);
INSERT INTO `t_work` VALUES ('WCZoIiPsmT', 'DDJHAT0SKb', 'ä»å¤©æ²¡æçä½ä¸', null, '01', '2016-09-23 10:35:07', '2016-09-24 10:35:07', '2016-09-23 10:32:39', '10', '1');
INSERT INTO `t_work` VALUES ('xvjYsncB9w', 'qJTKcpG0Mc', '测试作业内容啊啊', '4', '03', '2016-07-03 10:39:58', '2016-07-07 10:39:58', '2016-07-04 10:40:09', null, null);
